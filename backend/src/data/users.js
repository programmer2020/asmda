...
let _roles = [
  ...
  { id: 'manager',    label: 'مدير',        isSystem: false, pages: ['dashboard','notifications','product-cards','final-product-store','raw-materials-packaging-store','rep-sub-stores','financial-manager-custody','raw-materials-purchases','machine-maintenance-purchases','misc-purchases','payroll-advances','sales','checks','returns','customer-payment-alerts','free-samples','credit-sales','price-list','custodies','statement'] },
  ...
  { id: 'warehouse',  label: 'مخازن',       isSystem: false, pages: ['dashboard','notifications','product-cards','final-product-store','raw-materials-packaging-store','rep-sub-stores','raw-materials-purchases','machine-maintenance-purchases','misc-purchases'] },
